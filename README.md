...
npm run dev
Otherwise, simply open [Path to index.html, e.g., /app/index.html] in your web browser.The application should now be accessible at http://localhost:[Port Number, e.g., 8080].
